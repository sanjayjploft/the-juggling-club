      ...
      <main className="msar-main">
        ...
        <div className="container-fluid clb-plr-detl">
          ...
          <div className="card-grid-box">
            <div className="lndg-pg-card">              
              <div className="count-info-card">
                ...
                <p>Add up to 3 testimonials <Link href="/clubplayer-details" className=""><img src="/assets/image/edit.svg" /></Link></p>
              </div>
            </div>
            <div className="lndg-pg-card">              
              <div className="count-info-card">
                ...
                <p>Show/hide and customize display <Link href="/clubplayer-details" className=""><img src="/assets/image/edit.svg" /></Link></p>
              </div>
            </div>
            <div className="lndg-pg-card">              
              <div className="count-info-card">
                ...
                <p>Add up to 3 featured coaches <Link href="/clubplayer-details" className=""><img src="/assets/image/edit.svg" /></Link></p> 
              </div>
            </div>
          </div>
          ...
          <div className="tabb-content">
              ...
              <h3>Skill Progression
                <span>Overall progress through all skills and mindset challenges</span>
                  ...
                  <div className="date-det-skills-spot">
                    ...
                    <div>
                      <h5>It's fun, competitive, and actually improved my first touch.
                        <span>— Player 1</span>
                      </h5>
                      <p>
                  ...
                  <div className="date-det-skills-spot">
                    <div className="d-flex gap-3 align-items-center">
                    <div>
                      <h5>Our players love seeing their progress each week.
                        <span>— Coach 1</span>
                      </h5>
                      <p>
                      <label className="checkbox-wrapper">
                  ...
                  <Row>       
                    <Col md={5}>
                      <textarea className="" placeholder="Testimonial Text"></textarea>
                    </Col>
                  </Row>
            ...
            {activeTab === "billing" && <p>
              <h3>Page Sections
                <span>Add up to 3 player/parent/coach testimonials (max 300 chars each)</span>
              </h3>
                  ...
                  <div className="date-det-skills-spot mb-2">
                    ...
                    <div>
                      ...
                      <p className="mt-0 grdesd">Feature lead coach or ambassador</p>
                    </div> 
                    </div>
                    <div className="d-flex align-items-center gap-4 text-white">
                      <label className="checkbox-wrapper">
                  ...
                  <div className="date-det-skills-spot mb-2">
                    ...
                    <div>
                      ...
                      <p className="mt-0 grdesd">10-15s audio welcome message</p>
                    </div> 
                    </div>
                    <div className="d-flex align-items-center gap-4 text-white">
                      <label className="checkbox-wrapper">

        ...
        <div className="container-fluid clb-plr-detl">
          ...
          <div className="tabb-content">
            {activeTab === "profile" && <p>
              ...
              <Col lg={12}>
                <Button className="btn-next-bg mt-4">Save Branding Changes</Button>              
              </Col>
              </Row>
              </div>
                ...
                <Col md={12}>
                  <div className="date-det-skills-spot">
                    ...
                    <div>
                      ...
                      <p>15+ years of coaching experience with a passion for youth development.</p>
                    </div> 
                    </div>
                    <div className="d-flex align-items-center gap-4 text-white">
                      Show
                      <input class="switch mt-0" type="checkbox" />
                      <Link href="/clubplayer-details" className=""><img src="/assets/image/trash.svg" /></Link>
                    </div>                   
                  </div>
                </Col>               
              </Row>
            ...
            <Row>
              ...
              <Col md={10} className="chrtr-lmt">Max 300 Characters </Col>
            </Row>
            ...
            {activeTab === "settings" && <p>
              <h3>Club Administrators
                <span>Manage who can edit club content. Only Super Admins can manage other administrators.</span>
              </h3>
              <Row>
                <Col md={12}>
                  <div className="date-det-skills-spot">
            ...
            <Row className="adm-per">
              ...
              <label className="checkbox-wrapper">
                ...
                <span className="label-text">Upload and Update Club Logo</span>
              </label>
              <label className="checkbox-wrapper ms-5">
                <input type="checkbox" checked={checked} onChange={() => setChecked(!checked)} />
                <span className="custom-checkbox" />
                <span className="label-text">Edit Club Landing Page Content</span>
              </label>
              <label className="checkbox-wrapper ms-5">
                <input type="checkbox" checked={checked} onChange={() => setChecked(!checked)} />
                <span className="custom-checkbox" />
                <span className="label-text">Manage VoiceTag Recordings</span>
              </label>
              <label className="checkbox-wrapper ms-5">
                <input type="checkbox" checked={checked} onChange={() => setChecked(!checked)} />
                <span className="custom-checkbox" />
            ...
            <Button className="btn-next-bg mt-4">Add Admin</Button>
              ...
              <div className="upload-box" onClick={handleClick}>
                <div className="upload-content">
                  <div className="upload-icon"><img src="/assets/image/upload-icn.svg" /></div>
                  <p className="upload-text">Drop your logo here or click to upload</p>
                  <p className="upload-subtext">PNG, JPG, or GIF (max 5MB)</p>
                </div>
                <input ref={fileInputRef} type="file" accept="image/png,image/jpeg,image/gif" onChange={handleFileChange} hidden />
              </div>
              <h3 className="mt-5">VoiceTag Intro
                <span>Record a 10-15 second welcome message for your club landing page</span>
              </h3>
              <div className="upload-box" onClick={handleClick}>
                <div className="upload-content">
                  <div className="upload-icon"><img src="/assets/image/upload-icn.svg" /></div>
                  <p className="upload-text">Upload an audio message (MP3 or WAV)</p>

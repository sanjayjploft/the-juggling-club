...
const menu = [
  ...
  },
  {
    ...
    icon: "/assets/image/landing-page-menu.svg",
    activeIcon: "/assets/image/landing-page-menu-active.svg",
  },
  {
    name: "Club Codes",
    href: "/club-codes",
    icon: "/assets/image/club-codes-menu.svg",
    activeIcon: "/assets/image/club-codes-menu-active.svg",
  },
  {
    name: "Reports",
    href: "/reports",
